            ...
            <div className="container">
                <div className="theme-list__heading">
                    <span className="flex items-center heading">
                        ...
                        <h3 className="h3 capitalize text-secondary">
                            landscape tour
                        </h3>
                    </span>
                    <p className="text-lg">
                        Over the years, humans have built cities, communities,
                        statues, buildings and
                    </p>
                </div>
                <div className="theme-list__main">
                    <h4 className="h4 uppercase text-secondary">
                        Tour Of Themes
                    </h4>
