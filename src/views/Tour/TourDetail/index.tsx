            ...
            <div className="container flex main-wrapper relative">
                <div className="tour-detail__main">
                    <div className="about">
                        ...
                        <p className="text-lg">
                            If you want to escape from reality for a while and
                            rest your soul, join me in an easy walk along the
                            coast. I promise you a piece of paradise that will
                            enchant you and you will want to see even more.
                            Enjoy with me the sound of nature, the sound of the
                            sea, the swaying of the waves, the chirping of birds
                            and the view that will mesmerize you and leave you
                            speechless.
                        </p>
                    </div>
